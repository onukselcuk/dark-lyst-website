...
const PrivacyPolicy = () => {
    return (
        <main>
            <NextSeo
                title="DarkLyst Privacy Policy"
                noindex={true}
                openGraph={{
                    url: "https://www.darklyst.com/privacy-policy",
                    title: "DarkLyst Privacy Policy"
                }}
            />
            <section className="top-section">
                        ...
                        <ul>
                            ...
                            <li>
                                <p>
                                    ...
                                    this Agreement) refers to DarkLyst.
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                <strong>Website</strong> refers to DarkLyst,
                                accessible from https://darklyst.com
                            </li>{" "}
                            <li>
                ...
                <section className="sub-section">
                    ...
                    <div className="body-text">
                        <h2 className="subtitle">Types of Data Collected</h2>

                        <h3 className="sub-subtitle">Personal Data</h3>
                        <p>
                        ...
                        <h3 className="sub-subtitle">Usage Data</h3>
                        <p>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                You name, profile, pictures and description of
                        ...
                        <h3 className="sub-subtitle">Business Transactions</h3>
                        <p>
                        ...
                        <h3 className="sub-subtitle">Law enforcement</h3>
                        <p>
                ...
                <section className="sub-section">
                    <div className="top-bar">
                        <h1 className="top-bar-title">Children's Privacy</h1>
                    </div>
                    <div className="body-text">
                        <p>
                ...
                <section className="sub-section">
                    ...
                    <div className="body-text">
                        ...
                        <ul>
                            <li>By email: contact@darklyst.com</li>
                        </ul>
                    </div>
                </section>
            </section>
