    ...
    const getPersonTaggedImages = () => {
        ...
        axios.get(url).then((res) => {
            ...
            filteredImages = filteredImages.filter(
                (cur) => cur.media.release_date || cur.media.first_air_date
            );
        ...
        axios.get(url).then((res) => {
            ...
            filteredCast = filteredCast.filter(
                (cur) =>
                    cur.poster_path &&
                    cur.vote_average &&
                    (cur.release_date || cur.first_air_date)
            );
                ...
                <Fragment>
                    <NextSeo
                        ...
                        openGraph={{
                            ...
                            title: `${personDetails.name}`,
                            description: `${personDetails.biography.slice(
                                0,
                                130
                            )}`
                        }}
                    ...
                    />
                    {personTaggedImages && personTaggedImages.length > 0 && (
