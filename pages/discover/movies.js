...
import MovieLargeCard from "../../components/movie/MovieLargeCard";

const DiscoverMovie = ({ deviceType }) => {
	...
	const handleStateChange = async () => {
		...
		url = `${url}sort_by=${state.sortBy.value}.${isDescending ? "desc" : "asc"}`;
...
DiscoverMovie.getInitialProps = async ({ req }) => {
	let userAgent;
	let deviceType;
	if (req) {
