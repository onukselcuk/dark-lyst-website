...
const TermsAndConditions = () => {
    return (
        <main>
            <NextSeo
                title="DarkLyst Terms and Conditions"
                noindex={true}
                openGraph={{
                    url: "https://www.darklyst.com/terms-and-conditions",
                    title: "DarkLyst Terms and Conditions"
                }}
            />
            <section className="top-section">
                <section className="sub-section">
                    <div className="top-bar">
                        <h1 className="top-bar-title">Terms and Conditions</h1>
                    </div>
                ...
                <section className="sub-section">
                    <div className="top-bar">
                        <h1 className="top-bar-title">Acknowledgement</h1>
                    </div>
                    <div className="body-text">
                        <p>
                ...
                <section className="sub-section">
                    <div className="top-bar">
                        <h1 className="top-bar-title">Termination</h1>
                    </div>
                    <div className="body-text">
                        <p>
                ...
                <section className="sub-section">
                    <div className="top-bar">
                        <h1 className="top-bar-title">Governing Law</h1>
                    </div>
                    <div className="body-text">
                        <p>
                ...
                <section className="sub-section">
                    <div className="top-bar">
                        <h1 className="top-bar-title">Disputes Resolution</h1>
                    </div>
                    <div className="body-text">
                        <p>
                ...
                <section className="sub-section">
                    ...
                    <div className="body-text">
                        <h2 className="subtitle">Severability</h2>
                        <p>
                        ...
                        <h2 className="subtitle">Waiver</h2>
                        <p>
