        ...
        <div className="form-container">
            <div className="select-container network-select-container">
                ...
                <Select
                    ...
                    instanceId="network-select-id"
                    inputId="network-select-id"
                    className="select"
            ...
            <div className="select-container genres-select-container">
                ...
                <Select
                    id="genres-select-id"
                    instanceId="genres-select-id"
                    inputId="genres-select-id"
                    className="select"
            ...
            <div className="select-container rating-select-container ">
                ...
                <Select
                    id="rating-select-id"
                    instanceId="rating-select-id"
                    inputId="rating-select-id"
                    className="select"
            ...
            <div className="select-container years-select-container years-select-container-1 ">
                <div className="year-inner-container year-inner-container-1">
                    <label htmlFor="year-from-select-id">
                        First Air Year From (Jan 1st)
                    </label>
                    <Select
                        id="year-from-select-id"
                        instanceId="year-from-select-id"
                        inputId="year-from-select-id"
                        className="select"
                        options={yearsList}
                        defaultValue={yearsList[0]}
                        onChange={(selection) =>
                            handleChange(selection, "yearFrom")
                        }
                ...
                <div className="year-inner-container year-inner-container-2">
                    <label htmlFor="year-to-select-id">
                        First Air Year To (Dec 31st)
                    </label>
                    <Select
                        id="year-to-select-id"
                        inputId="year-to-select-id"
                        instanceId="year-to-select-id"
                        className="select"
                        options={yearsList}
                        defaultValue={yearsList[0]}
                        onChange={(selection) =>
                            handleChange(selection, "yearTo")
                        }
                        aria-label="Year To"
                        isSearchable={true}
                        styles={customStyles}
            ...
            <div className="select-container years-select-container years-select-container-2">
                <div className="year-inner-container year-inner-container-1">
                    <label htmlFor="last-air-year-from-select-id">
                        Last Air Year From (Jan 1st)
                    </label>
                    <Select
                        id="last-air-year-from-select-id"
                        instanceId="last-air-year-from-select-id"
                        inputId="last-air-year-from-select-id"
                        className="select"
                        options={yearsList}
                        defaultValue={yearsList[0]}
                        onChange={(selection) =>
                            handleChange(selection, "lastYearFrom")
                        }
                ...
                <div className="year-inner-container year-inner-container-2">
                    <label htmlFor="last-air-year-to-select-id">
                        Last Air Year To (Dec 31st)
                    </label>
                    <Select
                        id="last-air-year-to-select-id"
                        instanceId="last-air-year-to-select-id"
                        inputId="last-air-year-to-select-id"
                        className="select"
                        options={yearsList}
                        defaultValue={yearsList[0]}
                        onChange={(selection) =>
                            handleChange(selection, "lastYearTo")
                        }
            ...
            <div className="select-container language-select-container">
                ...
                <Select
                    ...
                    instanceId="language-select-id"
                    inputId="language-select-id"
                    className="select"
                    options={languageList}
                    defaultValue={languageList[0]}
                    onChange={(selection) =>
                        handleChange(selection, "originalLang")
                    }
                    aria-label="Language"
                    isSearchable={true}
                    styles={customStyles}
            ...
            <div className="select-container sort-by-select-container">
                ...
                <Select
                    ...
                    instanceId="sort-by-select-id"
                    inputId="sort-by-select-id"
                    className="select"
